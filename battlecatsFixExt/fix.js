...
// const script = document.querySelector('script[src="../script/unit_Customize_status.js"]');
// script.parentNode.removeChild(script);

//js code replication starts here
(function(L) {
    function B() {
        var b = !1;
        return function() {
    ...
    function w(b) {
        for (var a = 0; a < $("font.c05").length; a++)
            $("font.c05").eq(a).text($(b).val()),
            g(b, a)
    }
    function x(b) {
        for (var a = 0; a < $("font.c06").length; a++)
            $("font.c06").eq(a).text($(b).val()),
            h(b, a)
    }
    function g(b, a) {
    ...
    function z(b) {
        for (var a = 0; a < $("font.c11").length; a++) {
            var c = parseFloat($("font.c05").eq(a).text())
                , d = parseFloat($("font.c06").eq(a).text());
            c = f(a, c, d);
            at1c = Math.floor(Math.round($("font.at1").eq(a).text() * ((c + 4) / 5)) * (1 + 1.5 * (parseFloat($(b).val()) / 300)));
    ...
    function f(b, a, c) {
        b = $(".c02").eq(b).text();
        a += c;
        ("1\u57fa\u672c" == b || "1\u57fa\u672c\u7684" == b )? 60 < a && (a = (a - 60) / 2 + 60) : ("2EX\u30c9\u30ed\u30c3\u30d7" == b) ? 30 < a && (a = (a - 30) / 2 + 30) : ("2EX" == b || "2\u524d\u4efb" == b )? 60 < a && (a = (a - 60) / 2 + 60) : ("3\u30ec\u30a2" == b || "3\u7a00\u6709\u7684"==b )? 90 < a ? a = 80 + (a - 90) / 4 : 70 < a && (a = (a - 70) / 2 + 70) : ("4\u6fc0\u30ec\u30a2" == b || "4\u8d85\u7d1a\u7a00\u6709"==b) ? 80 < a ? a = 70 + (a - 80) / 4 : 60 < a && (a = (a - 60) / 2 + 60) : "4\u6fc0\u30ec\u30a2\u30e1\u30bf\u30eb" != b && ( ("4\u6fc0\u30ec\u30a2\u72c2\u4e71" == b || "4\u8d85\u7d1a\u7a00\u6709\u72c2\u4e71"==b) ? 20 < a && (a = 20 + (a - 20) / 2) : ("5\u8d85\u6fc0\u30ec\u30a2" == b || "5\u8d85\u7d1a\u7a00\u6709"==b) && (80 < a ? a = 70 + (a - 80) / 4 : 60 < a && (a = (a - 60) / 2 + 60)));
        return a
    }
    function A(b) {
        for (var a = 0; a < $("font.c19").length; a++) {
            var c = $("font.c19").eq(a).text() - (.3 * parseFloat($(b).val()) + 6 * (parseFloat($("#kenkyuLv").text()) + parseFloat($("#kenkyuPlus").text()) - 1));
            60 > c && (c = 60);
            c = Math.floor(c);
            r(a, c)
        }
    ...
    function v(b) {
        for (var a = 0; a < $("font.c19").length; a++) {
            var c = $("font.c19").eq(a).text() - (.3 * $("#takaraS").text() + 6 * (parseFloat($("#kenkyuLv").text()) + parseFloat($(b).val()) - 1));
            60 > c && (c = 60);
            c = Math.floor(c);
            r(a, c)
        }
    ...
    function t(b) {
        for (var a = 0; a < $("font.c17").length; a++) {
            ...
            100 >= c ? $("font.c18").eq(d).removeAttr("class").addClass("c18 H").text(e) : 200 >= c ? $("font.c18").eq(d).removeAttr("class").addClass("c18 LH").text(e) : 4E3 <= c ? $("font.c18").eq(d).removeAttr("class").addClass("c18 L").text(e) : 2E3 <= c ? $("font.c18").eq(d).removeAttr("class").addClass("c18 LL").text(e) : $("font.c18").eq(d).removeAttr("class").addClass("c18").text(e)
        }
    }
    function k(b, a) {
        if ("-" == a)
            ...
            1E5 <= a ? $("font.c08").eq(b).removeAttr("class").addClass("c08 H").text(c) : 5E4 <= a ? $("font.c08").eq(b).removeAttr("class").addClass("c08 LH").text(c) : 2E3 >= a ? $("font.c08").eq(b).removeAttr("class").addClass("c08 L").text(c) : 1E4 >= a ? $("font.c08").eq(b).removeAttr("class").addClass("c08 LL").text(c) : $("font.c08").eq(b).removeAttr("class").addClass("c08").text(c)
        }
    }
    function l(b, a) {
        var c = Number(a).toLocaleString();
    ...
    function p(b, a) {
        var c = Number(a).toLocaleString();
        5E4 <= a ? $("font.c12").eq(b).removeAttr("class").addClass("c12 H").text(c) : 25E3 <= a ? $("font.c12").eq(b).removeAttr("class").addClass("c12 LH").text(c) : 1E3 >= a ? $("font.c12").eq(b).removeAttr("class").addClass("c12 L").text(c) : 5E3 >= a ? $("font.c12").eq(b).removeAttr("class").addClass("c12 LL").text(c) : $("font.c12").eq(b).removeAttr("class").addClass("c12").text(c)
    }
    function q(b, a) {
        if ("-" == a)
            $("font.c13").eq(b);
            ...
            var c = Number(a).toLocaleString();
            1E4 <= a ? $("font.c13").eq(b).removeAttr("class").addClass("c13 H").text(c) : 5E3 <= a ? $("font.c13").eq(b).removeAttr("class").addClass("c13 LH").text(c) : 150 >= a ? $("font.c13").eq(b).removeAttr("class").addClass("c13 L").text(c) : 500 >= a ? $("font.c13").eq(b).removeAttr("class").addClass("c13 LL").text(c) : $("font.c13").eq(b).removeAttr("class").addClass("c13").text(c)
        }
    }
    function r(b, a) {
        90 >= a ? ($("font.c20").eq(b).removeAttr("class").addClass("c20 H").text(a),
        $("font.c30").eq(b).removeAttr("class").addClass("c30 H").text((a / 30).toFixed(2) + "\u79d2")) : 150 >= a ? ($("font.c20").eq(b).removeAttr("class").addClass("c20 LH").text(a),
        $("font.c30").eq(b).removeAttr("class").addClass("c30 LH").text((a / 30).toFixed(2) + "\u79d2")) : 3E3 <= a ? ($("font.c20").eq(b).removeAttr("class").addClass("c20 L").text(a),
        $("font.c30").eq(b).removeAttr("class").addClass("c30 L").text((a / 30).toFixed(2) + "\u79d2")) : 1500 <= a ? ($("font.c20").eq(b).removeAttr("class").addClass("c20 LL").text(a),
